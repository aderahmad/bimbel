...
class LupaPasswordController extends Controller
{
    public function formLupaPw() {
        return view('member.form-lupa-password');
    }
    ...
    public function prosesLupaPw(Request $req) {
        ...
        try {
            $datas = $req->all();
            $getData = Member::where('email', $datas['email'])->first();
            if(empty($getData)) {
    ...
    public function resetPassword($token) {
        ...
        return view('member.form-atur-ulang-password', compact('email', 'token'));
    }
    ...
    public function prosesResetPassword(Request $req)
    {
        ...
        $datas = $req->all();
        Member::where('email', $datas['email'])->update([
