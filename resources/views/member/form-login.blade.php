                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-5">
                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                ...
                                <div class="card-body">
                                    <form action="{{ route('login.proses-login') }}" method="POST" id="logForm">
                                        {{ csrf_field() }}
                                        ...
                                        <div
                                            ...
                                            <button class="btn btn-primary btn-block" type="submit" style="background-color:#9900cc;">Login</button>
                                        </div>
                                        
                                        <div
                                            class="form-group d-flex align-items-center justify-content-center mt-4 mb-0">
                                            
                                            <a class="small" href="{{ route('forgot.forgot') }}">Forgot Password?</a>
                                        </div>
                                ...
                                <div class="card-footer text-center">
                                    <div class="small">
                                        <a href="{{route('member.form-register')}}">Belum Punya Akun? Daftar!</a>
                                    </div>
                                </div>
                            </div>
                        </div>
