                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-7">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-body">
                                        <form action="{{ route('user.proses-input') }}" method="POST" id="regForm">
										{{ csrf_field() }}
                                            ...
                                            <div class="form-group mt-4 mb-0">
								                <button class="btn btn-primary btn-block" type="submit" style="background-color:#9900cc;"s>Buat</button>
											</div>
                                        </form>
                                    </div>
                                    <div class="card-footer text-center">
                                        <div class="small"><a href="{{ route('user.user-beranda') }}">kembali</a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
